...
Base.prototype.setDescription = function (description) {
  this.removeRelations("urn:X-hypercat:rels:hasDescription:en");
  this.addRelation("urn:X-hypercat:rels:hasDescription:en", description);
  return this;
}

Base.prototype.description = function() {
  if (this.values("urn:X-hypercat:rels:hasDescription:en"))
    return this.values("urn:X-hypercat:rels:hasDescription:en")[0];
  else return undefined;
  return this;
}

Base.prototype.setContentType = function (ct) {
  this.addRelation("urn:X-hypercat:rels:isContentType", ct);
  return this;
}

Base.prototype.contentType = function() {
  return this.values("urn:X-hypercat:rels:isContentType");
}
